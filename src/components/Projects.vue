...
<!--        Arvalet -->
        <div class="relative flex flex-col-reverse lg:flex-row w-full mb-14">
          <div>
            <a href="https://arvalet.com/" target="_blank" rel="noopener"><img class="transition duration-200 opacity-60 hover:opacity-80 shadow-md" src="../assets/arvalet.png" alt="Arvalet Project"></a>
          </div>
...
<!--            <p class="text-sm mb-0 text-mj-burgundy">Featured Project</p>-->
            ...
            <div class="flex items-center lg:flex-row-reverse gap-5 mb-6 lg:mb-0">
              ...
              <a href="https://arvalet.com/" title="External Link" rel="noopener" target="_blank"><ExternalLinkIcon class="w-6 h-6 text-mj-lavender transition duration-200 hover:text-mj-php-mellow" /></a>
            </div>
          </div>
        </div>
...
<!--        Applaince People-->
        <div class="relative flex flex-col-reverse lg:flex-row-reverse w-full mb-14">
          ...
          <div class="lg:absolute left-0 top-10 lg:w-1/2 lg:text-left">
            ...
            <ul class="flex lg:flex-row gap-x-5 font-mono text-sm mb-3">
              <li class="">JavaScript</li>
              <li>PHP</li>
              <li>CSS</li>
              <li>HTML</li>
